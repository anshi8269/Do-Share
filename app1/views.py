...
#-----------if user wants to explore products categories---
def products_view(request):
    return render(request , 'ecom/products.html')

#-----------if user wants to see clients reviews---
def clients_view(request):
    return render(request , 'ecom/clients.html')
...
def add_product_view(request):
    if request.method=="POST":
        ...
        print(name + price )
        en = Product(name = name , product_image=product_image , price=price , description=description)
        en.save()
